...
return [
    ...
    /*
     | The git SHA, set at deploy time. This is what turns "this error exists"
     | into "this error started at release X", which is the difference between
     | a hunt and a revert.
     */
    ...
    /*
     | Low in production on purpose. Full tracing on every request is
     | expensive and drowns the signal; staging runs at 1.0 where volume is
     | small and the detail is worth having.
     */
    ...
    /*
     | Left off deliberately. Sentry would otherwise attach request bodies,
     | cookies and user emails — merchant and shopper data we have no reason
     | to ship to a third party to read a stack trace. ErrorContext attaches
     | the user id and the tags we actually need instead.
     */
